...
export const WaterDropIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048l2.404-2.403A1.5 1.5 0 0110.5 3.525V3.75M16.5 9.75L12 14.25M12 14.25L7.5 9.75M12 14.25V21m0-13.138V3.75M12 2.25A2.23 2.23 0 009.77 4.48a2.23 2.23 0 002.23 2.23c1.235 0 2.23-.995 2.23-2.23A2.23 2.23 0 0012 2.25z" />
  </svg>
);

export const PrayingHandsIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58l-3.16-3.16m0 0L8.41 1.62M12.58 4.8L8.41 1.62M12.58 4.8L15.9 1.46M12.58 4.8l2.34 2.34" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.25 8.25L5.75 11.75" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.41 16.62a6 6 0 005.84-7.38V4.8m-5.84 2.58l3.16 3.16m0 0l3.43 3.43" />
  </svg>
);
